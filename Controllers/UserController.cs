...
namespace DopamineDetoxAPI.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(ApplicationDbContext context, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,
            IJwtService jwtService, IOptions<AppSettings> appSettings, ITopicService topicService, ISubTopicService subTopicService, IChannelService channelService, INoteService noteService, ITopSearchResultService topSearchResultService, IMapper mapper, INotificationService notificationService, ILoggingService loggingService)
        {
            _context = context;
